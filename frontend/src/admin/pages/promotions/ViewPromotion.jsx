      ...
      <div className="p-6">
        ...
        <div className="mb-6 rounded-2xl border border-gray-200 bg-white shadow-sm p-5 md:p-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Promotion Details</h1>
              <p className="text-sm text-gray-500 mt-1">View promotion information and status</p>
            </div>
