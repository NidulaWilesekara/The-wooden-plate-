...
const CreateMenuItem = () => {
  ...
  const fetchCategories = async () => {
    try {
      ...
      const response = await fetch('http://localhost:8000/api/admin/categories?is_active=1', {
        headers: {
    ...
    <AdminLayout>
      <div className="max-w-3xl mx-auto">
        <div className="mb-6 rounded-2xl border border-gray-200 bg-white shadow-sm p-5 md:p-6">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Create Menu Item</h1>
          <p className="text-sm text-gray-500 mt-1">Add a new menu item</p>
        </div>
